= How to open file in IDEA from a browser
...
- Currently, this API doesnʼt support inner class references in requests and construction like this: `FirstLeveClassName$InnerClassName:31`
...
- link:https://github.com/JetBrains/intellij-community/blob/a77365debaadcf00b888a977d89512f3f0f3cf9e/platform/built-in-server/src/org/jetbrains/ide/OpenFileHttpService.kt#L52[source code]
