...
You can find source code of this utility on the github: link:https://github.com/antkorwin/strong-soft-weak/blob/master/src/main/java/com/antkorwin/strongsoftweak/GcUtils.java[GcUtils.java]
