...
We will consider a simple banking application which makes the following operations on the each transfer of money by the client:
...
The following code will not work well, because it is incorrectly synchronized,
