...
----
<1> synchronization on the instance of UUID
...
The following code is not synchronized correctly, because UUID.fromString make new instance of UUID class on the each call.
