...
image:./concurrent_map_test_result.PNG[result of benchmarks]
...
You can consider this benchmark in more details here http://github.com/antkorwin[Concurrent map benchmark]
