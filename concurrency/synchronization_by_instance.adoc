...
we need to implementation a behavior that describes on the next diagram:
...
I packed this code into the XSync library,
...
Then you be able to make instances of the XSync for synchronization on types that you need.
