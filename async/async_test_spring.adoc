...
In my opinion this is unexpected behavior for a testing tool like the awaitility.
...
and  suggested to improve the documentation in Awaitility library.
All of these are successfully done.
