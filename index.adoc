...
link:./hr/employee-turnover/employee_turnover_cost.html[Как посчитать стоимость замены сотрудника при увольнении] (Russian) image:./statemachine/rus.png[russian,25] ::
