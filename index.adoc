...
link:./junit5/junit5_parallel_execution.html[How to use JUnit5 Parallel Execution of tests] (English) image:./statemachine/eng.png[english,25] ::
...
### State machine workshop live video - 18.05.2018
